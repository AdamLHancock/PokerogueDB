...
def get_trainer_type_enum(base_url: str) -> Enum:
    response_text = utils.get_response_text(f'{base_url}/src/enums/trainer-type.ts')
...
if __name__ == "__main__":
    ...
    species = get_trainer_type_enum(base)
